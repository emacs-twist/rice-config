...
The common code is maintained in a separate repository as a flake-parts module, so you don't have to merge upstream bugfixes by hand.
...
Check out elisp-workflows repository.
